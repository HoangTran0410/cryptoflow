...
const TimelineTracer: React.FC<TimelineTracerProps> = ({
  transactions,
  initialAddress = "",
}) => {
  ...
  const renderTimeline = () => {
    ...
    const eventGroups = g
      ...
      .attr(
        "transform",
        (d) => `translate(${xScale(d.timestamp)},${yScale(d.amount)})`
      )
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white">Timeline Tracer</h2>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 bg-slate-800 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${selectedEvent.significance * 100}%`,
                          }}
                        />
                      </div>
                  ...
                  {selectedEvent.relatedAddresses.length > 0 && (
                    <div>
                      <p className="text-slate-500 text-xs mb-2">
                        Related Addresses (
                        {selectedEvent.relatedAddresses.length})
                      </p>
                      <div className="space-y-1 max-h-48 overflow-y-auto">
                        {selectedEvent.relatedAddresses
                          .slice(0, 10)
                          .map((addr, idx) => (
                            <div
                              key={idx}
      ...
      {!address && (
        <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-12 text-center">
          ...
          <p className="text-slate-500">
            Enter an address to view chronological transaction activity
          </p>
        </div>
      )}
    </div>
