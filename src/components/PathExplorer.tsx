...
const PathExplorer: React.FC<PathExplorerProps> = ({
  ...
  const [direction, setDirection] = useState<"inflow" | "outflow" | "both">(
    "both"
  );
  ...
  const handleTrace = async () => {
    ...
    const cacheKey = generateCacheKey("deepTrace", {
      address,
      direction,
      depth,
    });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white">Path Explorer</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-4">
              ...
              <p className="text-white text-2xl font-bold">
                {result.statistics.executionTime.toFixed(0)}ms
              </p>
            </div>
          </div>
